...
void _tim2_irq_handler(void) {
    ...
    strncpy((char *) tx_msg.str, TICK_STR, BUFFER_SIZE);

    tx_msg.size = strlen(TICK_STR);
    tx_msg.idx = 0;
    tx_msg.done = false;
